...
public class GuiMariosletter extends ElementsAssassincrownMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiMariosletter(ElementsAssassincrownMod instance) {
		super(instance, 142);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("assassincrown:textures/mariosletter.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("assassincrown:textures/map (4).png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + -1, this.guiTop + -5, 0, 0, -1, -1, -1, -1);
		}
