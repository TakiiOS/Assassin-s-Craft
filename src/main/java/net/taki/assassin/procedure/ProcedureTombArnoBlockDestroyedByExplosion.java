...
public class ProcedureTombArnoBlockDestroyedByExplosion extends ElementsAssassincrownMod.ModElement {
	public ProcedureTombArnoBlockDestroyedByExplosion(ElementsAssassincrownMod instance) {
		super(instance, 85);
	}
