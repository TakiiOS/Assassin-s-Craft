...
public class ProcedureTombEzioReBlockDestroyedByPlayer extends ElementsAssassincrownMod.ModElement {
	public ProcedureTombEzioReBlockDestroyedByPlayer(ElementsAssassincrownMod instance) {
		super(instance, 75);
	}
