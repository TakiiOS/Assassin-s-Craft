...
public class ProcedureHojaOcultaActRightClickedOnBlock extends ElementsAssassincrownMod.ModElement {
	public ProcedureHojaOcultaActRightClickedOnBlock(ElementsAssassincrownMod instance) {
		super(instance, 11);
	}
