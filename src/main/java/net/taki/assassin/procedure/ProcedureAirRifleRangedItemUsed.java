...
public class ProcedureAirRifleRangedItemUsed extends ElementsAssassincrownMod.ModElement {
	public ProcedureAirRifleRangedItemUsed(ElementsAssassincrownMod instance) {
		super(instance, 70);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		world.playSound((EntityPlayer) null, x, y, z,
				(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("assassincrown:rifleshot")),
