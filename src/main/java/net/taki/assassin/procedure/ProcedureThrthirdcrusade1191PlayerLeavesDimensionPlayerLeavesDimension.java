...
import net.taki.assassin.item.ItemMapkingdom;
...
public class ProcedureThrthirdcrusade1191PlayerLeavesDimensionPlayerLeavesDimension extends ElementsAssassincrownMod.ModElement {
	public ProcedureThrthirdcrusade1191PlayerLeavesDimensionPlayerLeavesDimension(ElementsAssassincrownMod instance) {
		super(instance, 156);
	}
