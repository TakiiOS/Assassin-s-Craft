...
import net.taki.assassin.item.ItemSryingeEagleVision;
import net.taki.assassin.item.ItemEmptySyringe;
...
public class ProcedureEagleVisionRightClickedInAir extends ElementsAssassincrownMod.ModElement {
	public ProcedureEagleVisionRightClickedInAir(ElementsAssassincrownMod instance) {
		super(instance, 104);
	}
