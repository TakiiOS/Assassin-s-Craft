...
public class ProcedureTombConnorBlockDestroyedByPlayer extends ElementsAssassincrownMod.ModElement {
	public ProcedureTombConnorBlockDestroyedByPlayer(ElementsAssassincrownMod instance) {
		super(instance, 77);
	}
