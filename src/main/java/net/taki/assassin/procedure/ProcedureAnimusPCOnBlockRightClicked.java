...
public class ProcedureAnimusPCOnBlockRightClicked extends ElementsAssassincrownMod.ModElement {
	public ProcedureAnimusPCOnBlockRightClicked(ElementsAssassincrownMod instance) {
		super(instance, 179);
	}
