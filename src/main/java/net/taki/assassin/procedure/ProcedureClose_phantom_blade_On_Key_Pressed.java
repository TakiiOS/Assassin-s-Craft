...
public class ProcedureClose_phantom_blade_On_Key_Pressed extends ElementsAssassincrownMod.ModElement {
	public ProcedureClose_phantom_blade_On_Key_Pressed(ElementsAssassincrownMod instance) {
		super(instance, 174);
	}
