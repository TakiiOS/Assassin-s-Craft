...
public class ProcedureThethirdcrusade1189PlayerEntersDimension extends ElementsAssassincrownMod.ModElement {
	public ProcedureThethirdcrusade1189PlayerEntersDimension(ElementsAssassincrownMod instance) {
		super(instance, 155);
	}
