...
public class ProcedureTombAltairBlockDestroyedByPlayer extends ElementsAssassincrownMod.ModElement {
	public ProcedureTombAltairBlockDestroyedByPlayer(ElementsAssassincrownMod instance) {
		super(instance, 71);
	}
