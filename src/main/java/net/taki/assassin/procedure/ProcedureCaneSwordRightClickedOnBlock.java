...
public class ProcedureCaneSwordRightClickedOnBlock extends ElementsAssassincrownMod.ModElement {
	public ProcedureCaneSwordRightClickedOnBlock(ElementsAssassincrownMod instance) {
		super(instance, 45);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		world.playSound((EntityPlayer) null, x, y, z,
				(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("assassincrown:sword_des")),
