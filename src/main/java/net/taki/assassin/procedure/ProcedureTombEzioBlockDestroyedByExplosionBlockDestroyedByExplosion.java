...
public class ProcedureTombEzioBlockDestroyedByExplosionBlockDestroyedByExplosion extends ElementsAssassincrownMod.ModElement {
	public ProcedureTombEzioBlockDestroyedByExplosionBlockDestroyedByExplosion(ElementsAssassincrownMod instance) {
		super(instance, 76);
	}
