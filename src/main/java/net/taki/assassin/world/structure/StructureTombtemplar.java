...
public class StructureTombtemplar extends ElementsAssassincrownMod.ModElement {
	public StructureTombtemplar(ElementsAssassincrownMod instance) {
		super(instance, 96);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2250) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("assassincrown", "templar_tomb"));
				if (template == null)
					return;
