...
package net.taki.assassin.world;

import net.taki.assassin.procedure.ProcedureThrthirdcrusade1191PlayerLeavesDimensionPlayerLeavesDimension;
import net.taki.assassin.procedure.ProcedureThethirdcrusade1189PlayerEntersDimension;
...
public class WorldThethirdcrusade1189 extends ElementsAssassincrownMod.ModElement {
	public static int DIMID = 9;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldThethirdcrusade1189(ElementsAssassincrownMod instance) {
		super(instance, 153);
	}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("assassincrown:syrianlands")),
				Biome.REGISTRY.getObject(new ResourceLocation("assassincrown:syrianplains")),
