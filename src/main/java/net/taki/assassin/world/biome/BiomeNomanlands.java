...
public class BiomeNomanlands extends ElementsAssassincrownMod.ModElement {
	@GameRegistry.ObjectHolder("assassincrown:nomanlands")
	public static final BiomeGenCustom biome = null;
	public BiomeNomanlands(ElementsAssassincrownMod instance) {
		super(instance, 88);
	}
