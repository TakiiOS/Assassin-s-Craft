...
public class BiomeSyrianDunes extends ElementsAssassincrownMod.ModElement {
	@GameRegistry.ObjectHolder("assassincrown:syriandunes")
	public static final BiomeGenCustom biome = null;
	public BiomeSyrianDunes(ElementsAssassincrownMod instance) {
		super(instance, 162);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Syrian Dunes").setRainfall(0F).setBaseHeight(0.1F).setWaterColor(-14329397).setHeightVariation(0F)
