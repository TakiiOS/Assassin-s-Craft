...
import net.taki.assassin.procedure.ProcedureClose_Guantlet;
...
public class KeyBindingClose_gauntlet_key extends ElementsAssassincrownMod.ModElement {
	private KeyBinding keys;
	public KeyBindingClose_gauntlet_key(ElementsAssassincrownMod instance) {
		super(instance, 176);
	}
