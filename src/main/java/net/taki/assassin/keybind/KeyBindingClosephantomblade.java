...
package net.taki.assassin.keybind;

import org.lwjgl.input.Keyboard;

import net.taki.assassin.procedure.ProcedureClose_phantom_blade_On_Key_Pressed;
...
public class KeyBindingClosephantomblade extends ElementsAssassincrownMod.ModElement {
	private KeyBinding keys;
	public KeyBindingClosephantomblade(ElementsAssassincrownMod instance) {
		super(instance, 174);
	}
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				AssassincrownMod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
