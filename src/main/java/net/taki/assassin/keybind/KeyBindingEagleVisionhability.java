...
import net.taki.assassin.procedure.ProcedureEagleVisionhabilityOnKeyPressed;
...
public class KeyBindingEagleVisionhability extends ElementsAssassincrownMod.ModElement {
	private KeyBinding keys;
	public KeyBindingEagleVisionhability(ElementsAssassincrownMod instance) {
		super(instance, 106);
	}
