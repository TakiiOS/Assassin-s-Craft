...
import net.taki.assassin.item.ItemEagleFeather;
...
public class EntityEagle extends ElementsAssassincrownMod.ModElement {
	public static final int ENTITYID = 14;
	public static final int ENTITYID_RANGED = 15;
	public EntityEagle(ElementsAssassincrownMod instance) {
		super(instance, 92);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("assassincrown", "eagle"), ENTITYID).name("eagle").tracker(64, 3, true).egg(-1, -6710887).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("assassincrown:nomanlands")),
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelcustom_model(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("assassincrown:textures/eaglexd.png");
				}
			};
		});
	}
