...
public class ItemAltairsword extends ElementsAssassincrownMod.ModElement {
	@GameRegistry.ObjectHolder("assassincrown:altairsword")
	public static final Item block = null;
	public ItemAltairsword(ElementsAssassincrownMod instance) {
		super(instance, 167);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassincrown:altairsword", "inventory"));
	}
}
