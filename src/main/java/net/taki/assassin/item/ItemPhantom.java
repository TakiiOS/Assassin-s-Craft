...
import net.taki.assassin.procedure.ProcedurePhantomRightClickedOnBlock;
...
public class ItemPhantom extends ElementsAssassincrownMod.ModElement {
	@GameRegistry.ObjectHolder("assassincrown:phantom")
	public static final Item block = null;
	public ItemPhantom(ElementsAssassincrownMod instance) {
		super(instance, 27);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassincrown:phantom", "inventory"));
	}
