...
import net.taki.assassin.procedure.ProcedureEagleVisionRightClickedInAir;
...
public class ItemSryingeEagleVision extends ElementsAssassincrownMod.ModElement {
	@GameRegistry.ObjectHolder("assassincrown:sryingeeaglevision")
	public static final Item block = null;
	public ItemSryingeEagleVision(ElementsAssassincrownMod instance) {
		super(instance, 110);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassincrown:sryingeeaglevision", "inventory"));
	}
