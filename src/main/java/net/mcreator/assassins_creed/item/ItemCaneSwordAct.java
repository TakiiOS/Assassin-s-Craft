...
import net.mcreator.assassins_creed.procedure.ProcedureCaneSwordActRightClickedOnBlock;
...
public class ItemCaneSwordAct extends ElementsAssassinsCraftMod.ModElement {
	@GameRegistry.ObjectHolder("assassins_craft:caneswordact")
	public static final Item block = null;
	public ItemCaneSwordAct(ElementsAssassinsCraftMod instance) {
		super(instance, 44);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassins_craft:caneswordact", "inventory"));
	}
}
