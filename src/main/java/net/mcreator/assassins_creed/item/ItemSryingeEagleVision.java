...
import net.mcreator.assassins_creed.procedure.ProcedureEagleVisionRightClickedInAir;
...
public class ItemSryingeEagleVision extends ElementsAssassinsCraftMod.ModElement {
	@GameRegistry.ObjectHolder("assassins_craft:sryingeeaglevision")
	public static final Item block = null;
	public ItemSryingeEagleVision(ElementsAssassinsCraftMod instance) {
		super(instance, 110);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassins_craft:sryingeeaglevision", "inventory"));
	}
