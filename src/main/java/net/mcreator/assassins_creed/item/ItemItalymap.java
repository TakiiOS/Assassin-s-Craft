...
import net.mcreator.assassins_creed.procedure.ProcedureItalymapRightClickedOnBlock;
...
public class ItemItalymap extends ElementsAssassinsCraftMod.ModElement {
	@GameRegistry.ObjectHolder("assassins_craft:italymap")
	public static final Item block = null;
	public ItemItalymap(ElementsAssassinsCraftMod instance) {
		super(instance, 139);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassins_craft:italymap", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 1;
			setUnlocalizedName("italymap");
			setRegistryName("italymap");
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				ProcedureItalymapRightClickedOnBlock.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
