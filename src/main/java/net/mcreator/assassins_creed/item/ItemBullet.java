...
public class ItemBullet extends ElementsAssassinsCraftMod.ModElement {
	@GameRegistry.ObjectHolder("assassins_craft:bullet")
	public static final Item block = null;
	public ItemBullet(ElementsAssassinsCraftMod instance) {
		super(instance, 5);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassins_craft:bullet", "inventory"));
	}
