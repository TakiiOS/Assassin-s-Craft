...
import net.mcreator.assassins_creed.procedure.ProcedureKigndomRightClickedOnBlock;
...
public class ItemMapkingdom extends ElementsAssassinsCraftMod.ModElement {
	@GameRegistry.ObjectHolder("assassins_craft:mapkingdom")
	public static final Item block = null;
	public ItemMapkingdom(ElementsAssassinsCraftMod instance) {
		super(instance, 193);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassins_craft:mapkingdom", "inventory"));
	}
