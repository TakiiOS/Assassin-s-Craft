...
import net.mcreator.assassins_creed.procedure.ProcedureHojaOcultaActRightClickedOnBlock;
...
public class ItemHoja_OcultaAct extends ElementsAssassinsCraftMod.ModElement {
	@GameRegistry.ObjectHolder("assassins_craft:hoja_ocultaact")
	public static final Item block = null;
	public ItemHoja_OcultaAct(ElementsAssassinsCraftMod instance) {
		super(instance, 7);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassins_craft:hoja_ocultaact", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(20);
			maxStackSize = 1;
			setUnlocalizedName("hoja_ocultaact");
			setRegistryName("hoja_ocultaact");
			setCreativeTab(null);
		}
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				ProcedureHojaOcultaActRightClickedOnBlock.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
