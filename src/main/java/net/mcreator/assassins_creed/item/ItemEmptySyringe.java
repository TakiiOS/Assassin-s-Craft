...
public class ItemEmptySyringe extends ElementsAssassinsCraftMod.ModElement {
	@GameRegistry.ObjectHolder("assassins_craft:emptysyringe")
	public static final Item block = null;
	public ItemEmptySyringe(ElementsAssassinsCraftMod instance) {
		super(instance, 108);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassins_craft:emptysyringe", "inventory"));
	}
