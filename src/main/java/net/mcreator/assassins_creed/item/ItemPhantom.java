...
import net.mcreator.assassins_creed.procedure.ProcedurePhantomRightClickedOnBlock;
...
public class ItemPhantom extends ElementsAssassinsCraftMod.ModElement {
	@GameRegistry.ObjectHolder("assassins_craft:phantom")
	public static final Item block = null;
	public ItemPhantom(ElementsAssassinsCraftMod instance) {
		super(instance, 27);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassins_craft:phantom", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				ProcedurePhantomRightClickedOnBlock.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
