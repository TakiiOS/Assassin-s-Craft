...
import net.mcreator.assassins_creed.procedure.ProcedureAirRifleRangedItemUsed;
...
public class ItemAirRifle extends ElementsAssassinsCraftMod.ModElement {
	@GameRegistry.ObjectHolder("assassins_craft:airrifle")
	public static final Item block = null;
	public static final int ENTITYID = 7;
	public ItemAirRifle(ElementsAssassinsCraftMod instance) {
		super(instance, 68);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("assassins_craft", "entitybulletairrifle"), ENTITYID).name("entitybulletairrifle").tracker(64, 1, true)
				.build());
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("assassins_craft:airrifle", "inventory"));
	}
