...
import net.mcreator.assassins_creed.procedure.ProcedureClose_phantom_blade_On_Key_Pressed;
...
public class KeyBindingClosephantomblade extends ElementsAssassinsCraftMod.ModElement {
	private KeyBinding keys;
	public KeyBindingClosephantomblade(ElementsAssassinsCraftMod instance) {
		super(instance, 174);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.closephantomblade", Keyboard.KEY_U, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureClose_phantom_blade_On_Key_Pressed.executeProcedure($_dependencies);
		}
	}
}
