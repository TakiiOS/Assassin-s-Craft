...
package net.mcreator.assassins_creed.keybind;
...
import net.mcreator.assassins_creed.procedure.ProcedureEagleVisionhabilityOnKeyPressed;
...
public class KeyBindingEagleVisionhability extends ElementsAssassinsCraftMod.ModElement {
	private KeyBinding keys;
	public KeyBindingEagleVisionhability(ElementsAssassinsCraftMod instance) {
		super(instance, 106);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.eaglevisionhability", Keyboard.KEY_V, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				AssassinsCraftMod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureEagleVisionhabilityOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
