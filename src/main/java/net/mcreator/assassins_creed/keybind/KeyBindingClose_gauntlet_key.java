...
import net.mcreator.assassins_creed.procedure.ProcedureClose_Guantlet;
...
public class KeyBindingClose_gauntlet_key extends ElementsAssassinsCraftMod.ModElement {
	private KeyBinding keys;
	public KeyBindingClose_gauntlet_key(ElementsAssassinsCraftMod instance) {
		super(instance, 176);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.close_gauntlet_key", Keyboard.KEY_U, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureClose_Guantlet.executeProcedure($_dependencies);
		}
	}
}
