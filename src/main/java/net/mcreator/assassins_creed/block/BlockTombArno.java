...
import net.mcreator.assassins_creed.procedure.ProcedureTombArnoBlockDestroyedByPlayer;
import net.mcreator.assassins_creed.procedure.ProcedureTombArnoBlockDestroyedByExplosion;
...
public class BlockTombArno extends ElementsAssassinsCraftMod.ModElement {
	@GameRegistry.ObjectHolder("assassins_craft:tombarno")
	public static final Block block = null;
	public BlockTombArno(ElementsAssassinsCraftMod instance) {
		super(instance, 83);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("assassins_craft:tombarno", "inventory"));
	}
