...
import net.mcreator.assassins_creed.item.ItemLongsword;
import net.mcreator.assassins_creed.ElementsAssassinsCraftMod;

@ElementsAssassinsCraftMod.ModElement.Tag
public class EntityTemplarKnight extends ElementsAssassinsCraftMod.ModElement {
	public static final int ENTITYID = 22;
	public static final int ENTITYID_RANGED = 23;
	public EntityTemplarKnight(ElementsAssassinsCraftMod instance) {
		super(instance, 171);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("assassins_craft", "templarknight"), ENTITYID)
						.name("templarknight").tracker(7, 3, true).egg(-10092544, -1).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("assassins_craft:syrianplains")),
				Biome.REGISTRY.getObject(new ResourceLocation("assassins_craft:syriandunes")),
				Biome.REGISTRY.getObject(new ResourceLocation("assassins_craft:syrianlands")),};
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("assassins_craft:textures/caballero_templario.png");
				}
			};
