...
public class EntityTemplarofficer extends ElementsAssassinsCraftMod.ModElement {
	public static final int ENTITYID = 18;
	public static final int ENTITYID_RANGED = 19;
	public EntityTemplarofficer(ElementsAssassinsCraftMod instance) {
		super(instance, 164);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("assassins_craft", "templarofficer"), ENTITYID)
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("assassins_craft:textures/templar_officer.png");
				}
			};
