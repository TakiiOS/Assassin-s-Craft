...
public class ProcedureTombJacobBlockDestroyedByPlayer extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureTombJacobBlockDestroyedByPlayer(ElementsAssassinsCraftMod instance) {
		super(instance, 86);
	}
