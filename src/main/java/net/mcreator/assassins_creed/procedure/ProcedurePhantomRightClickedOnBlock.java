...
public class ProcedurePhantomRightClickedOnBlock extends ElementsAssassinsCraftMod.ModElement {
	public ProcedurePhantomRightClickedOnBlock(ElementsAssassinsCraftMod instance) {
		super(instance, 50);
	}
