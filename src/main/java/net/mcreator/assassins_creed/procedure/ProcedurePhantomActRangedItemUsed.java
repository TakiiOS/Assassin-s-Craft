...
public class ProcedurePhantomActRangedItemUsed extends ElementsAssassinsCraftMod.ModElement {
	public ProcedurePhantomActRangedItemUsed(ElementsAssassinsCraftMod instance) {
		super(instance, 31);
	}
