...
public class ProcedureGuiAnimusItalybutton extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureGuiAnimusItalybutton(ElementsAssassinsCraftMod instance) {
		super(instance, 128);
	}
