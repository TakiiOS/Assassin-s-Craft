...
public class ProcedureTombAltairBlockDestroyedByExplosion extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureTombAltairBlockDestroyedByExplosion(ElementsAssassinsCraftMod instance) {
		super(instance, 72);
	}
