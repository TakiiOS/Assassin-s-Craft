...
public class ProcedureCaneSwordActRightClickedOnBlock extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureCaneSwordActRightClickedOnBlock(ElementsAssassinsCraftMod instance) {
		super(instance, 46);
	}
