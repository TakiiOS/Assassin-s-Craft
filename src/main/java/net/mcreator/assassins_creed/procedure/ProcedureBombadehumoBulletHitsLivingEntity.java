...
public class ProcedureBombadehumoBulletHitsLivingEntity extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureBombadehumoBulletHitsLivingEntity(ElementsAssassinsCraftMod instance) {
		super(instance, 38);
	}
