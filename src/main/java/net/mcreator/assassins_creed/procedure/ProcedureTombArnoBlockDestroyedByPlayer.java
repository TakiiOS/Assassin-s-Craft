...
public class ProcedureTombArnoBlockDestroyedByPlayer extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureTombArnoBlockDestroyedByPlayer(ElementsAssassinsCraftMod instance) {
		super(instance, 84);
	}
