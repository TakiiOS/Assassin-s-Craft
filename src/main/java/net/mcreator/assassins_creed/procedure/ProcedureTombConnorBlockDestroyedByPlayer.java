...
public class ProcedureTombConnorBlockDestroyedByPlayer extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureTombConnorBlockDestroyedByPlayer(ElementsAssassinsCraftMod instance) {
		super(instance, 77);
	}
