...
public class ProcedureTobEivorBlockDestroyedByPlayer extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureTobEivorBlockDestroyedByPlayer(ElementsAssassinsCraftMod instance) {
		super(instance, 188);
	}
