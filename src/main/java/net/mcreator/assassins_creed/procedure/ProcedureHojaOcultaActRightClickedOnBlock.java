...
public class ProcedureHojaOcultaActRightClickedOnBlock extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureHojaOcultaActRightClickedOnBlock(ElementsAssassinsCraftMod instance) {
		super(instance, 11);
	}
