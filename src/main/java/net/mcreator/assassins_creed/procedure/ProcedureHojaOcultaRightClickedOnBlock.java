...
public class ProcedureHojaOcultaRightClickedOnBlock extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureHojaOcultaRightClickedOnBlock(ElementsAssassinsCraftMod instance) {
		super(instance, 52);
	}
