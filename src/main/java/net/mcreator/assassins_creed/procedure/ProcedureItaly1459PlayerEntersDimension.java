...
import net.mcreator.assassins_creed.item.ItemMariosLetteritem;
import net.mcreator.assassins_creed.item.ItemItalymap;
...
public class ProcedureItaly1459PlayerEntersDimension extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureItaly1459PlayerEntersDimension(ElementsAssassinsCraftMod instance) {
		super(instance, 126);
	}
