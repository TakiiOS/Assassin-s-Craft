...
public class ProcedureTombJacobBlockDestroyedByExplosion extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureTombJacobBlockDestroyedByExplosion(ElementsAssassinsCraftMod instance) {
		super(instance, 87);
	}
