...
public class ProcedureItaly1459PlayerLeavesDimension extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureItaly1459PlayerLeavesDimension(ElementsAssassinsCraftMod instance) {
		super(instance, 127);
	}
