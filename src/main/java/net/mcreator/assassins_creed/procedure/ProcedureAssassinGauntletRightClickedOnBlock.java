...
public class ProcedureAssassinGauntletRightClickedOnBlock extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureAssassinGauntletRightClickedOnBlock(ElementsAssassinsCraftMod instance) {
		super(instance, 58);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		world.playSound((EntityPlayer) null, x, y, z, (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
				.getObject(new ResourceLocation("assassins_craft:hoja_oculta_act")), SoundCategory.NEUTRAL, (float) 1, (float) 1);
	}
}
