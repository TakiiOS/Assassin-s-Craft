...
public class ProcedureTomahawkBulletHitsLivingEntity extends ElementsAssassinsCraftMod.ModElement {
	public ProcedureTomahawkBulletHitsLivingEntity(ElementsAssassinsCraftMod instance) {
		super(instance, 65);
	}
