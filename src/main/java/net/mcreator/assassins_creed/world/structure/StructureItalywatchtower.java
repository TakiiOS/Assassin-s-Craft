...
public class StructureItalywatchtower extends ElementsAssassinsCraftMod.ModElement {
	public StructureItalywatchtower(ElementsAssassinsCraftMod instance) {
		super(instance, 148);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("assassins_craft", "italian_watchtower"));
				if (template == null)
					return;
