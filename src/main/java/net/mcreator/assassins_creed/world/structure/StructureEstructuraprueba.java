...
public class StructureEstructuraprueba extends ElementsAssassinsCraftMod.ModElement {
	public StructureEstructuraprueba(ElementsAssassinsCraftMod instance) {
		super(instance, 90);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 2750) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("assassins_craft", "altair_tomb"));
				if (template == null)
					return;
