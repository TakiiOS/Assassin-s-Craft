...
public class StructureItalychurch extends ElementsAssassinsCraftMod.ModElement {
	public StructureItalychurch(ElementsAssassinsCraftMod instance) {
		super(instance, 149);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1200) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("assassins_craft", "italian_church"));
				if (template == null)
					return;
