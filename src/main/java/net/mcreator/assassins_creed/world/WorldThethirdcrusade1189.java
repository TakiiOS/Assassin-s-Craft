...
package net.mcreator.assassins_creed.world;
...
import net.mcreator.assassins_creed.procedure.ProcedureThrthirdcrusade1191PlayerLeavesDimensionPlayerLeavesDimension;
import net.mcreator.assassins_creed.procedure.ProcedureThethirdcrusade1189PlayerEntersDimension;
...
public class WorldThethirdcrusade1189 extends ElementsAssassinsCraftMod.ModElement {
	public static int DIMID = 9;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldThethirdcrusade1189(ElementsAssassinsCraftMod instance) {
		super(instance, 153);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension thethirdcrusade1189 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("thethirdcrusade1189", "_thethirdcrusade1189", DIMID, WorldProviderMod.class, true);
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0.678431372549, 0.643137254902, 0.439215686275);
		}
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureThethirdcrusade1189PlayerEntersDimension.executeProcedure($_dependencies);
			}
		}
		...
		public void onPlayerRemoved(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureThrthirdcrusade1191PlayerLeavesDimensionPlayerLeavesDimension.executeProcedure($_dependencies);
			}
		}
	}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("assassins_craft:syrianlands")),
				Biome.REGISTRY.getObject(new ResourceLocation("assassins_craft:syrianplains")),
				Biome.REGISTRY.getObject(new ResourceLocation("assassins_craft:syriandunes")),};
