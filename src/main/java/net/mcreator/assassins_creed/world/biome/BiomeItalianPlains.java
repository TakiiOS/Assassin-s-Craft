...
public class BiomeItalianPlains extends ElementsAssassinsCraftMod.ModElement {
	@GameRegistry.ObjectHolder("assassins_craft:italianplains")
	public static final BiomeGenCustom biome = null;
	public BiomeItalianPlains(ElementsAssassinsCraftMod instance) {
		super(instance, 125);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("italianplains").setRainfall(0.2F).setBaseHeight(0.1F).setWaterColor(-16750951).setHeightVariation(0F)
