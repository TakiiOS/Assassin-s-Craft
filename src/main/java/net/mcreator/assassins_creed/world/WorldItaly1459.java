...
import net.mcreator.assassins_creed.procedure.ProcedureItaly1459PlayerLeavesDimension;
import net.mcreator.assassins_creed.procedure.ProcedureItaly1459PlayerEntersDimension;
...
public class WorldItaly1459 extends ElementsAssassinsCraftMod.ModElement {
	public static int DIMID = 8;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldItaly1459(ElementsAssassinsCraftMod instance) {
		super(instance, 126);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension italy1459 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("italy1459", "_italy1459", DIMID, WorldProviderMod.class, true);
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureItaly1459PlayerEntersDimension.executeProcedure($_dependencies);
			}
		}
		...
		public void onPlayerRemoved(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureItaly1459PlayerLeavesDimension.executeProcedure($_dependencies);
			}
		}
	}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("assassins_craft:italianplains")),};
